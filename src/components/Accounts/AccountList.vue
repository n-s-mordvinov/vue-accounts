...
<template>
  <div class="account-list">
    <div class="mb-6">
      ...
      <p class="text-color-secondary m-0 mt-1">Добавляйте, редактируйте и удаляйте учетные записи</p>
    </div>
    <div class="card mb-6">
      <div class="flex align-items-start">
        ...
        <div>
          ...
          <p class="text-color-secondary m-0 mt-1">Для указания нескольких меток для одной пары логин/пароль используйте заделитель ;</p>
        </div>
      </div>
    </div>
